...
Items = ["ANTIDOTE","AWAKENING","BICYCLE","BIKE VOUCHER","BURN HEAL","CALCIUM",
"CARD KEY","COIN CASE","DIRE HIT","DOME FOSSIL","ELIXER","ESCAPE ROPE",
"ETHER","EXPERIENCE ALL","FIRE STONE","FRESH WATER","FULL HEAL","GOLD TEETH",
"GREAT BALL","GUARD SPECIAL","HELIX FOSSIL","HP UP","ICE HEAL","LEAF STONE",
"LEMONADE","LIFT KEY","Master Ball","Max Elixir","MAX ETHER","MAX POTION",
"MAX REPEL","MAX REVIVE","MOON STONE","NUGGET","OAK'S PARCEL","OLD AMBER",
"OLD ROD","PARALYZE HEAL","POKE DOLL","POKE FLUTE","PP UP","PROTEIN","REVIVE",
"S.S. TICKET","SAFARI BALL","SECRET KEY","SILPH SCOPE","SODA POP",
"SUPER POTION","SUPER REPEL","SUPER ROD","THUNDER STONE","TOWN MAP",
"ULTRA BALL","WATER STONE","X ACCURACY","X ATTACK","X DEFEND","X SPECIAL",
"X SPEED"]

def create_random_toy!(pokemon)
  Toy.create!(
    pokemon_id: pokemon.id,
    name: Items.sample.upcase,
